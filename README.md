...
2. [O que este servidor faz](#o-que-este-servidor-faz)
3. [Arquitetura e Justificativa Técnica](#real-time-event-driven-architecture)
4. [Tecnologias Utilizadas](#tecnologias-utilizadas)
5. [Como rodar localmente](#como-rodar-localmente)
6. [Como fazer deploy](#como-fazer-deploy)
